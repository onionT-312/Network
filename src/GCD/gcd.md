...
- 2: PKT_RESULT:
	...
	- data đằng sau gồm 4 bytes: int, little endian, là kết quả phép toán UCLN(a,b);
	- Kết quả phép toán UCLN(a,b) được bảo đảm là sẽ nằm trong phạm vi [0... 2^32-1]
- 3: PKT_BYE
