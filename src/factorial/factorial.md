...
- 1: PKT_CALC
	...
	- data đằng sau sẽ gồm 4 bytes là năm
- 2: PKT_RESULT:
	- Client gửi kết quả bằng gói tin này sau khi nhận PKT_CALC
	- Trường len có giá trị bằng 4
	- data đằng sau là string tra về "Nam nhuan" hoặc "Nam khong nhuan"
- 3: PKT_BYE
	- Server từ chối kết quả, kết nối chấm dứt
- 4: PKT_FLAG
	- Server gửi gói tin này sau khi client trả lời hết đúng
